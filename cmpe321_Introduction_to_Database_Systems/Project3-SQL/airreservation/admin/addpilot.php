      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div id="contact" class="col-md-8">
            <form id="employee-form" method="POST" action="actionpilot.php">
              <div class="col-lg-9 col-md-6 col-sm-12 col-xs-12">
                <input name="pilotID" type="text" id="pilotID" class="form-control field" 
                 data-validation="required, pilotID"
              ...
              <div class="col-lg-9 col-md-6 col-sm-12 col-xs-12">
                <input name="isfree" type="text" id="isfree" class="form-control field" data-validation="required"
                placeholder="isfree" /><br>
              </div>
              
              <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <input type="submit" id="add-pilot" class="btn btn-md center-block" value="Add" />
