        ...
        <div class="row">
          ...
          <div id="contact" class="col-md-8">
            <form id="flight-form" method="POST" action="updateflight.php?id=<?php echo $_GET['id'] ?>">
              ...
              <div class="col-lg-9 col-md-6 col-sm-12 col-xs-12">
                <input name="traveltime" type="text" id="traveltime" class="form-control field" data-validation="required"
              ...
              <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <input type="submit" id="update-flight" class="btn btn-md center-block" value="Update" />
