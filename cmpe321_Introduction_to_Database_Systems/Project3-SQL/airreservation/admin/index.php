...
<head>
  ...
  <link href='style.css' rel='stylesheet'/>
    <div id='index'>
        <br>
        <h1><font color="#983A00">Airline Reservation System</font></a></h1>
        <div id='user'>
        <br>
        <br>
        <br>
...
<body>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <a href="employee.php" class="btn btn-primary btn-overlap" 
        style="font-family: Smart Kid; font-size: 28px; padding-top: 2px; padding-bottom: 5px; margin-bottom: 10px; line-height:100%">EMPLOYEES</a>
    </div> 
    <div class="col-sm-3">
