...
contract Lottery {
    ...
    uint blockLimitPurchase = 20000; // Purchase Ticket round limit. After contract pass 20000 block, ticket purchase not allowed until next lottery.
    uint blockLimitLottery = 40000; // Reveal Number and also lottery limit. After that time, reveal number part not allowed.
